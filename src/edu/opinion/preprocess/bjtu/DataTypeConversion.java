...
//		try {
//			DataTypeConversion s = new DataTypeConversion();
//			String time = "http://www.sina.com.cn 2008-04-20 21:41匹配";
//			Date date = s.timeTypeConversion(time);
//			System.out.println(date);
//
//			String reNum = "阅读数1000 回帖数24740tt？";
//			int renum = s.reNumtypeConversion(reNum);
